...
<head>
    ...
    <style {csp-style-nonce}>
        ...
        *:focus {
            ...
            /* Um tom mais escuro para o foco */
            outline: none;
        }
        ...
        body {
            color: #f8f9fa;
            /* Um branco mais suave para o texto principal */
        ...
        header {
            ...
            /* Um tom mais escuro para o cabeçalho */
            padding: .4rem 0 0;
        }
        ...
        header ul {
            ...
            /* Uma cor mais escura para a borda */
        ...
        header li a {
            border-radius: 5px;
            color: #adb5bd;
            /* Um cinza mais claro para os links */
            display: block;
            height: 44px;
        ...
        header li.menu-item a:focus {
            ...
            /* Um tom mais claro para o hover/focus */
            color: #fff;
            /* Texto branco no hover/focus */
        }
        ...
        section {
            ...
            color: #f8f9fa;
            /* Texto branco na seção */
        }

        section h1 {
            margin-bottom: 2.5rem;
            color: #fff;
            /* Título branco na seção */
        }
        ...
        section h2 {
            ...
            padding-top: 1.5rem;
            color: #e9ecef;
            /* Subtítulo branco na seção */
        }

        section pre {
            background-color: #495057;
            /* Fundo mais escuro para o pre */
            border: 1px solid #6c757d;
            /* Borda mais escura para o pre */
            display: block;
            font-size: .9rem;
            margin: 2rem 0;
            padding: 1rem 1.5rem;
        ...
        section code {
            display: block;
            color: #e9ecef;
            /* Texto branco no code */
        }

        section a {
            color: #fca311;
            /* Uma cor de destaque diferente para links */
        }
        ...
        section svg {
            ...
            width: 25px;
            fill: #f8f9fa;
            /* Cor branca para o fill do SVG */
            stroke: #f8f9fa;
            /* Cor branca para o stroke do SVG */
        }

        .further {
            background-color: #343a40;
            /* Fundo mais escuro para a seção further */
            border-bottom: 1px solid #495057;
            /* Borda mais escura */
        ...
        footer {
            ...
            /* Um tom mais escuro da cor principal do footer */
            text-align: center;
            color: #fff;
        ...
        footer .copyrights {
            background-color: #212529;
            /* Fundo mais escuro para os copyrights */
            color: #adb5bd;
            /* Texto cinza claro */
        ...
        @media (max-width: 629px) {
            ...
            header .menu-item {
                background-color: #495057;
                /* Fundo mais escuro para os itens do menu */
            ...
            header li.menu-item a {
                ...
                /* Tom mais claro no menu mobile */
                color: #fff;
                /* Texto branco no menu mobile */
            }

            header li.menu-item a:hover,
            header li.menu-item a:focus {
                background-color: rgba(221, 72, 20, .8);
                /* Tom mais claro no hover/focus mobile */
                color: #e9ecef;
            }
        }
    </style>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="http://127.0.0.1:57000/src/public/observer/react"
                        target="_blank">[Docker] - React.php</a></li>
                <li class="menu-item hidden"><a href="http://127.0.0.1/src/public/observer/react"
                        target="_blank">[Laragon] - React.php</a></li>
                <li class="menu-item hidden"><a href="http://127.0.0.1:57000/src/public/observer/codeigniter"
                        target="_blank">[Docker] - Codeigniter.php</a></li>
                <li class="menu-item hidden"><a href="http://127.0.0.1/src/public/observer/codeigniter"
                        target="_blank">[Laragon] - Codeigniter.php</a></li>
                <li class="menu-item hidden"><a href="https://codeigniter.com/user_guide/" target="_blank">Docs</a>
                </li>
                <li class="menu-item hidden"><a href="http://127.0.0.1:7777/" target="_blank">[Docker] - 7777</a></li>
                <li class="menu-item hidden"><a href="http://127.0.0.1:9999/" target="_blank">[Docker] - 9999</a></li>
                </li>
            </ul>
        </div>
        ...
        <div class="heroe">
            <div>
                ...
                <br />/*
                <br />
                <br />Possíveis ambientes dev para react:
                <br />
                <br />[DEV1/Docker]
                <br />
                <br />cd C:\laragon\www\hform\src\public\script\react_modelo_v3\frontend\src
                <br />npm run dev -- --host 127.0.0.1 --port 7777
                <br />
                <br />[DEV2/Laragon]
                <br />
                <br />cd C:\laragon\www\hform\src\public\script\react_modelo_v3\frontend\src
                <br />npm run dev -- --host localhost --port 9999
                <br />
                <br />*/
                <br />
                <br />cd C:\laragon\www\hform\src\public\script\react_modelo_v3\frontend\src
